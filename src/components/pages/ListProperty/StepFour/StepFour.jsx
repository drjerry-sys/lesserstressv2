            ...
            <Typography variant="h5" pt={2} style={{ fontSize: "25px", paddingTop: "10px"}}>Show the Image of your place?</Typography>
                {formData.radio === 'no' && (
                    <Paper variant="outlined" square elevation={16} className={classes.paper}>
                        ...
                        <InputBase type="file" onChange={handleChange} style={{display: 'none'}} inputProps={{multiple: true}} id="comp" name="comp_image" className={classes.roomImg} />
                ...
                <Paper variant="outlined" square elevation={16} className={classes.paper}>
                    ...
                    <InputBase type="file" inputProps={{multiple: true}} style={{display: 'none'}} id="room" onChange={handleChange} name="room_image" />
